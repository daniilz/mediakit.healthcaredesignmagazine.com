	                    ...
	                    <?php while (have_posts()) : the_post(); ?>
							...
							<?php if($previous_pdf_title) { ?>   
				                <div class="table-footer">
				                    <span class="pdf-link"><a href="<?=$previous_pdf_link;?>" target="_blank"><img src="/prod/wp-content/themes/hdmk/images/PDFlogo.png" alt="pdf" class="PDF_LogoLink"><?=$previous_pdf_title;?></a></span>
				                </div>
				            <? } ?>  	
	                    <?php endwhile; ?>              
                    <?php endif; ?>
